...
urlpatterns = [
    ...
    path('all-categories/', views.all_blogs,name="all-blogs"),
    ...
    path('my-blogs/<username>/', views.my_blogs,name="my_blogs"),
    path('add-blog/<username>', views.add_blog,name="add-blog"),
